...
def main():
    ...
    print(f"Hemisphere: {str(vol_hemisphere(2))}")
    print(f"Circular Cylinder: {str(vol_circular_cylinder(2, 2))}")
    print(f"Conical Frustum: {str(vol_conical_frustum(2, 2, 4))}")
    print(f"Spherical cap: {str(vol_spherical_cap(1, 2))}")
    print(f"Spheres intersetion: {str(vol_spheres_intersect(2, 2, 1))}")
